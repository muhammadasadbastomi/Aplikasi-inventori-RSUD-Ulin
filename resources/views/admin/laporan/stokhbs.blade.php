...
<head>
    ...
    <title>Laporan Data Stok Barang Hampir Habis</title>
...
<body>
    ...
    <div class="container" style="margin-top:-40px;">
        <h3 style="text-align:center;text-transform: uppercase;">Laporan Data Stok Barang Hampir Habis</h3>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if($d->stok < 6) <td scope="col" class="text-center" style="border-color: black; color:red;">{{ $d->stok }}</td>
                        @else <td scope="col" class="text-center"> {{ $d->stok }}</td>
                        @endif
                </tr>
                @endforeach
            </tbody>
