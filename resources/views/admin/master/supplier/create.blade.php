            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="body">
                        ...
                        <label>Alamat</label>
                        <div class="form-group">
                            <textarea type="text" name="alamat" id="alamat" placeholder="Masukkan Alamat"
                                class="form-control @error ('alamat') is-invalid @enderror"> {{old('alamat')}}</textarea>
                            @error('alamat')<div class="invalid-feedback"> {{$message}} </div>@enderror
                        </div>
                        <label>Telepon</label>
                        <div class="form-group">
                            <input type="number" name="telepon" id="telepon" placeholder="Masukkan Nomor Telepon"
                                value="{{old('telepon')}}"
                        ...
                        <div class="form-group">
                            <textarea type="text" name="keterangan" id="keterangan" placeholder="Masukkan Keterangan"
